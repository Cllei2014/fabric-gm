...
func (goPlatform *Platform) GetDeploymentPayload(path string) ([]byte, error) {
	...
	var provided = map[string]bool{
		"github.com/tw-bc-group/fabric-gm/core/chaincode/shim": true,
		"github.com/tw-bc-group/fabric-gm/protos/peer":         true,
	}
	...
	for _, file := range files {
		...
		// original file.Name:  src/github.com/tw-bc-group/fabric-gm/examples/chaincode/go/marbles02/META-INF/statedb/couchdb/indexes/indexOwner.json
