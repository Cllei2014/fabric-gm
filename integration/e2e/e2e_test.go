...
import (
	...
	"github.com/tw-bc-group/fabric-gm/common/tools/configtxgen/localconfig"
	"github.com/tw-bc-group/fabric-gm/core/aclmgmt/resources"
	"github.com/tw-bc-group/fabric-gm/integration/nwo"
	"github.com/tw-bc-group/fabric-gm/integration/nwo/commands"
	"github.com/tw-bc-group/fabric-gm/integration/nwo/fabricconfig"
	"github.com/tw-bc-group/fabric-gm/protos/common"
	protosorderer "github.com/tw-bc-group/fabric-gm/protos/orderer"
...
var _ = Describe("EndToEnd", func() {
	...
	BeforeEach(func() {
		...
		chaincode = nwo.Chaincode{
			Name:    "mycc",
			Version: "0.0",
			Path:    "github.com/tw-bc-group/fabric-gm/integration/chaincode/simple/cmd",
